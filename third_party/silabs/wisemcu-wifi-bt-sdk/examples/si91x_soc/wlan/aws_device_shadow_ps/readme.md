...
3. Under provider, check the *SoC* checkbox. 

4. Now choose AWS IoT Device Shadow with M4 Powersave example and click on **Create**.
      
   **![AWS PS project](resources/readme/aws_ps_example_soc.png)**

5. Give the desired name to your project and cick on **Finish**.

   **![Create AWS PS project](resources/readme/create_project.png)**
...
Configure the following parameters in **rsi_aws_device_shadow_ps.c** to enable Silicon Labs Wi-Fi device to connect Wi-Fi network.
...
Configure `ALARM_PERIODIC_TIME` in the file **rsi_app_config.h file** .
```c
...
Without powersave
  ...
  ![Figure: Debug Prints without powersave](resources/readme/application_prints_without_powersave.png)

With powersave

  ![Figure: Debug Prints with powersave](resources/readme/application_prints_with_powersave.png)
