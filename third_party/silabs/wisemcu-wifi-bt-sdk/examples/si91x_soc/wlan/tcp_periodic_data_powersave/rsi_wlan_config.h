...
#define RSI_CUSTOM_FEATURE_BIT_MAP \
  (FEAT_CUSTOM_FEAT_EXTENTION_VALID | CUSTOM_FEAT_SOC_CLK_CONFIG_160MHZ | FEAT_CUSTOM_FEAT_EXTENTION_VALID)

// To set Extended custom feature select bit map
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP (EXT_FEAT_LOW_POWER_MODE | EXT_FEAT_XTAL_CLK_ENABLE)

#define RSI_EXT_TCPIP_FEATURE_BITMAP (CONFIG_FEAT_EXTENTION_VALID | EXT_TCP_IP_WINDOW_DIV)
