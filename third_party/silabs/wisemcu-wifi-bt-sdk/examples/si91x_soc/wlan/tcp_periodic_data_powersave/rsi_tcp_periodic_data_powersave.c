...
#define ALARM_CONFIG 1

#ifdef ALARM_CONFIG
volatile uint8_t gotosleep = 0;
...
#define ALARM_PERIODIC_TIME       30 //300 /*<! periodic alarm configuration in SEC */
...
#else
  /* Configure RAM Usage and Retention Size */
  RSI_WISEMCU_ConfigRamRetention(WISEMCU_256KB_RAM_IN_USE, WISEMCU_RETAIN_DEFAULT_RAM_DURING_SLEEP);
