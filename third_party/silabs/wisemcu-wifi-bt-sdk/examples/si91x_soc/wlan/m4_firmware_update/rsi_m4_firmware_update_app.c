/*******************************************************************************
* @file  rsi_m4_firmware_update_app.c
* @brief
*******************************************************************************
* # License
...
/*================================================================================
 * @brief : This file contains example application for m4 firmware upgradation from
 * server
 * @section Description :
 * This application demonstrates how to upgrade new m4 firmware to Silicon Labs device
