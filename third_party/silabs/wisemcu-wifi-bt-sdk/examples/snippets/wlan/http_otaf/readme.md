...
![Figure: Setup Diagram SoC Mode for WLAN Throughput Example](resources/readme/otafsoc.png)
  
#### NCP Mode :  

![Figure: Setup Diagram NCP Mode for WLAN Throughput Example](resources/readme/otafncp.png)
...
### 5.4 Running the SiWx91x Application
