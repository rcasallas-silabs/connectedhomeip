...
- **SoC Mode**:
   - [Silicon Labs EFR32xG21 Starter Kit with Wireless Gecko](https://www.silabs.com/) (SLSWSTK6006A Base board: BRD4001A, Radio board: BRD4325A)
...
![Figure: Setup Diagram SoC Mode for Station Ping Example](resources/readme/setup_soc.png)
...
4. Now choose Wi-Fi- NCP  Client ICMP Ping example for NCP mode or choose Wi-Fi- SoC Client ICMP Ping example for SoC mode and click on **Create**.
