...
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP \
  (EXT_FEAT_LOW_POWER_MODE | EXT_FEAT_XTAL_CLK_ENABLE | EXT_FEAT_DISABLE_DEBUG_PRINTS)
...
//! Beacon missed count
#define RSI_REJOIN_BEACON_MISSED_COUNT 80
...
//! roaming threshold value
#define RSI_TIMEOUT_BIT_MAP BIT(2)

//! roaming hysterisis value
#define RSI_TIMEOUT_VALUE 0
