...
#define VAD_DIGITAL_GAIN_FAC 4   /*Digital multiplication value,if this value is 5 then each ADC sample will multiply by 32. 
								   data =  data << VAD_DIGITAL_GAIN_FAC */
#define ULP_MEMORY_BASE 0x24060000
#define TEST_SAMPL_VAL  32
#define VAD_MASK_VALUE  0xFC00

#define DATA_FROM_INTER_ADC 1   /* For feeding voice data to VAD from RS14100 ADC then make this macro as 1, 
