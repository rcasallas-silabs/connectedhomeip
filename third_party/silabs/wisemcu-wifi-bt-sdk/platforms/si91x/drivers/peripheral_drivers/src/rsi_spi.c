...
#else
      if (spi->instance_mode == SPI_MASTER_MODE) {
            if ((spi->io.cs->pin == 9) || (spi->io.cs->pin == 16) || (spi->io.cs->pin == 28) || (spi->io.cs->pin == 42)
                || (spi->io.cs->pin == 73)) {
              /*cs0*/
              spi->reg->SER = 0x0 << 0;
            } else if ((spi->io.cs->pin == 10) || (spi->io.cs->pin == 17) || (spi->io.cs->pin == 29)
                       || (spi->io.cs->pin == 43) || (spi->io.cs->pin == 64) || (spi->io.cs->pin == 70)) {
              /*cs1*/
              spi->reg->SER = 0x0 << 1;
            } else if ((spi->io.cs->pin == 20) || (spi->io.cs->pin == 30) || (spi->io.cs->pin == 35)
                       || (spi->io.cs->pin == 44) || (spi->io.cs->pin == 48) || (spi->io.cs->pin == 65)) {
              /*cs2*/
              spi->reg->SER = 0x0 << 2;
