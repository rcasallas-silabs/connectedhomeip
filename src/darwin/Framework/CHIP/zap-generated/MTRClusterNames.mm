...
NSString * MTRAttributeNameForID(MTRClusterIDType clusterID, MTRAttributeIDType attributeID)
{
    ...
    case MTRClusterIDTypeMulticastID:
        ...
        case MTRAttributeIDTypeClusterMulticastAttributeGroupsID:
            result = @"Groups";
            break;
...
NSString * MTRRequestCommandNameForID(MTRClusterIDType clusterID, MTRCommandIDType commandID)
{
    ...
    case MTRClusterIDTypeMulticastID:
        ...
        case MTRCommandIDTypeClusterMulticastCommandSetGroupID:
            result = @"SetGroup";
            break;

        case MTRCommandIDTypeClusterMulticastCommandRemoveGroupID:
            result = @"RemoveGroup";
            break;
