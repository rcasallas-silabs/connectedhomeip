...
- (NSString *)description
{
    NSString * descriptionString = [NSString stringWithFormat:@"<%@: groupId:%@; endpoints:%@; keyId:%@; fabricIndex:%@; >", NSStringFromClass([self class]), _groupId, _endpoints, _keyId, _fabricIndex];
    return descriptionString;
}
