...
typedef NS_ENUM(uint32_t, MTRAttributeIDType) {
    ...
    MTRAttributeIDTypeClusterMulticastAttributeTargetID MTR_PROVISIONALLY_AVAILABLE = 0x00000000,
...
typedef NS_ENUM(uint32_t, MTRCommandIDType) {
    ...
    MTRCommandIDTypeClusterMulticastCommandAddTargetID MTR_PROVISIONALLY_AVAILABLE = 0x00000000,
