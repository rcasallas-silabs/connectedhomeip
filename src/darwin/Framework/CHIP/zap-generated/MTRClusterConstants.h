...
typedef NS_ENUM(uint32_t, MTRAttributeIDType) {
    ...
    MTRAttributeIDTypeClusterMulticastAttributeGroupsID MTR_PROVISIONALLY_AVAILABLE = 0x00000000,
...
typedef NS_ENUM(uint32_t, MTRCommandIDType) {
    ...
    MTRCommandIDTypeClusterMulticastCommandSetGroupID MTR_PROVISIONALLY_AVAILABLE = 0x00000000,
    MTRCommandIDTypeClusterMulticastCommandRemoveGroupID MTR_PROVISIONALLY_AVAILABLE = 0x00000001,
