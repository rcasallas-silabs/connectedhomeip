...
typedef NS_ENUM(uint32_t, MTRClusterIDType) {
    ...
    MTRClusterIDTypeGroupcastID MTR_PROVISIONALLY_AVAILABLE = 0x00000064,
...
typedef NS_ENUM(uint32_t, MTRCommandIDType) {
    ...
    MTRCommandIDTypeClusterGroupcastCommandLeaveAllGroupsID MTR_PROVISIONALLY_AVAILABLE = 0x00000003,
    MTRCommandIDTypeClusterGroupcastCommandJoinGroupResponseID MTR_PROVISIONALLY_AVAILABLE = 0x00000081,
