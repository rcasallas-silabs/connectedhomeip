...
MTR_PROVISIONALLY_AVAILABLE
@interface MTRGroupcastClusterLeaveAllGroupsParams : NSObject <NSCopying>
...
MTR_PROVISIONALLY_AVAILABLE
@interface MTRGroupcastClusterJoinGroupResponseParams : NSObject <NSCopying>

@property (nonatomic, copy) NSData * _Nonnull address MTR_PROVISIONALLY_AVAILABLE;

/**
 * Initialize an MTRGroupcastClusterJoinGroupResponseParams with a response-value dictionary
 * of the sort that MTRDeviceResponseHandler would receive.
 *
 * Will return nil and hand out an error if the response-value dictionary is not
 * a command data response or is not the right command response.
