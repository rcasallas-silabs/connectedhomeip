...
MTR_PROVISIONALLY_AVAILABLE
@interface MTRMulticastClusterAddTargetParams : NSObject <NSCopying>

@property (nonatomic, copy) MTRMulticastClusterMulticastAddStruct * _Nonnull target MTR_PROVISIONALLY_AVAILABLE;
/**
 * Controls whether the command is a timed command (using Timed Invoke).
 *
 * If nil (the default value), a regular invoke is done for commands that do
