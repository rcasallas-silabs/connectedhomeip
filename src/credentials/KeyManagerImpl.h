...
{
    return TLV::EstimateStructOverhead(sizeof(uint16_t) + sizeof(uint16_t) + sizeof(uint8_t), sizeof(uint64_t)); //KeySet::kEpochKeysMax * Crypto::GroupOperationalCredentials
}
