...
GroupDataProvider::EndpointIterator * GroupDataProviderImpl::IterateEndpoints(FabricIndex fabric_index, Optional<GroupId> group_id)
{
    VerifyOrReturnError(IsInitialized(), nullptr);
    VerifyOrReturnError(kUndefinedFabricIndex != fabric_index, nullptr);
...
GroupDataProviderImpl::EndpointIteratorImpl::EndpointIteratorImpl(GroupDataProviderImpl & provider, FabricIndex fabric_index, Optional<GroupId> group_id) :
    mProvider(provider),
    mFabric(fabric_index)
