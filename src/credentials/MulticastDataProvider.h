...
struct TargetKey
{
    ...
    {
        memcpy(this->encryption.AsMutable<Crypto::Symmetric128BitsKeyByteArray>(), t.encryption.As<Crypto::Symmetric128BitsKeyByteArray>(), sizeof(Crypto::Symmetric128BitsKeyByteArray));
        memcpy(this->privacy.AsMutable<Crypto::Symmetric128BitsKeyByteArray>(), t.encryption.As<Crypto::Symmetric128BitsKeyByteArray>(), sizeof(Crypto::Symmetric128BitsKeyByteArray));
