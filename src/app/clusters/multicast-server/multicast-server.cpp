...
public:
    ...
    CHIP_ERROR Read(const ConcreteReadAttributePath & aPath, AttributeValueEncoder & aEncoder) override
    {
        ...
        case Attributes::Groups::Id:
            return ReadMulticastGroups(aPath.mEndpointId, aEncoder);
        default:
            break;
        }
...
private:
    ...
    CHIP_ERROR ReadMulticastGroups(EndpointId endpoint, AttributeValueEncoder & aEncoder)
    {
        ...
        CHIP_ERROR err = aEncoder.EncodeList([&multicast](const auto & encoder) -> CHIP_ERROR {
            ...
            for (auto & fabric : Server::GetInstance().GetFabricTable())
            {
                ...
                auto iter         = multicast.IterateGroups(fabric_index);
                VerifyOrReturnError(nullptr != iter, CHIP_ERROR_NO_MEMORY);
                chip::Multicast::Group entry;
                while (iter->Next(entry))
                {
                    Clusters::Multicast::Structs::MulticastGroupStruct::Type target;
                    ...
                    ChipLogProgress(Crypto, "~~~ Multicast::ReadMulticastGroups: g:#%04x, ec:%u #%02x", (unsigned) target.groupId,
...
bool emberAfMulticastClusterSetGroupCallback(
    chip::app::CommandHandler * commandObj, const chip::app::ConcreteCommandPath & commandPath,
    const chip::app::Clusters::Multicast::Commands::SetGroup::DecodableType & commandData)
{
    ...
    err = multicast.SetGroup(fabric, target, ByteSpan(key), commandData.gracePeriod);
...
bool emberAfMulticastClusterRemoveGroupCallback(
    chip::app::CommandHandler * commandObj, const chip::app::ConcreteCommandPath & commandPath,
    const chip::app::Clusters::Multicast::Commands::RemoveGroup::DecodableType & commandData)
{
    return false;
}
