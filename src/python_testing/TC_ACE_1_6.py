...
from TC_GC_common import get_feature_map, get_iana_multicast_address, get_operate_only_commands, get_per_group_multicast_address, is_groupcast_on_root_node
...
class TC_ACE_1_6(MatterBaseTest):
    ...
    async def test_TC_ACE_1_6(self):
        ...
        if not gc_on_root:
            ...
            asserts.assert_equal(event_data.destinationIpAddress, get_iana_multicast_address(), "Incorrect destination IP address in event")
            ...
            expected_dest_addr = get_per_group_multicast_address(self.default_controller.fabricId, groupID2) if pga_enabled else get_iana_multicast_address()
