...
class MulticastCluster(private val controller: MatterController, private val endpointId: UShort) {
  class TargetAttribute(val value: List<MulticastClusterMulticastTargetStruct>)
  ...
  suspend fun addTarget(
    target: MulticastClusterMulticastAddStruct,
    ...
    target.toTlv(ContextSpecificTag(TAG_TARGET_REQ), tlvWriter)
  ...
  suspend fun writeTargetAttribute(
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          emit(TargetAttributeSubscriptionState.Success(decodedValue))
        }
