...
public static class MulticastClusterMulticastGroupStruct {
  public Integer groupId;
  public ArrayList<Integer> endpoints;
  public Integer fabricIndex;
  private static final long GROUP_ID_ID = 1L;
  ...
  public MulticastClusterMulticastGroupStruct(
    Integer groupId,
    ArrayList<Integer> endpoints,
    Integer fabricIndex
  ) {
  ...
  public static MulticastClusterMulticastGroupStruct decodeTlv(BaseTLVType tlvValue) {
    if (tlvValue == null || tlvValue.type() != TLVType.Struct) {
      return null;
    }
    Integer groupId = null;
    ...
    return new MulticastClusterMulticastGroupStruct(
      groupId,
      endpoints,
      fabricIndex
    );
  ...
  public String toString() {
    StringBuilder output = new StringBuilder();
    output.append("MulticastClusterMulticastGroupStruct {\n");
    output.append("\tgroupId: ");
    output.append(groupId);
    output.append("\n");
    output.append("\tendpoints: ");
