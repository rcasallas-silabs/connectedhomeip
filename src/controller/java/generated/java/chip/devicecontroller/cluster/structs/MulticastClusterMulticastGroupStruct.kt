...
class MulticastClusterMulticastGroupStruct(
  val groupId: UInt,
  val endpoints: List<UInt>,
  val fabricIndex: UInt,
) {
  override fun toString(): String = buildString {
    append("MulticastClusterMulticastGroupStruct {\n")
  ...
  companion object {
    ...
    fun fromTlv(tlvTag: Tag, tlvReader: TlvReader): MulticastClusterMulticastGroupStruct {
      ...
      return MulticastClusterMulticastGroupStruct(groupId, endpoints, fabricIndex)
    }
  }
}
