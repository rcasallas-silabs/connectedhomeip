...
public class ClusterIDMapping {
    ...
    public static class Groupcast implements BaseCluster {
        ...
        public enum Command {
            ...
            public static Command value(long id) throws NoSuchFieldError {
                ...
                throw new NoSuchFieldError();
        ...
        }public enum JoinGroupCommandField {GroupId(0),Endpoints(1),Key(2),GroupName(3),GracePeriod(4),;
                    private final int id;
                ...
                }public enum LeaveAllGroupsCommandField {Endpoints(0),;
                    private final int id;
                    LeaveAllGroupsCommandField(int id) {
                        this.id = id;
                    }
                    ...
                    public static LeaveAllGroupsCommandField value(int id) throws NoSuchFieldError {
                        for (LeaveAllGroupsCommandField field : LeaveAllGroupsCommandField.values()) {
                        if (field.getID() == id) {
                            return field;
                        }
                        }
