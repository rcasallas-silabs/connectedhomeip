...
public class ClusterIDMapping {
    ...
    public static class Multicast implements BaseCluster {
        ...
        public enum Command {
            ...
            public static Command value(long id) throws NoSuchFieldError {
                ...
                throw new NoSuchFieldError();
        ...
        }public enum AddTargetCommandField {Target(0),;
                    private final int id;
                    AddTargetCommandField(int id) {
                        this.id = id;
                    }
                    ...
                    public static AddTargetCommandField value(int id) throws NoSuchFieldError {
                        for (AddTargetCommandField field : AddTargetCommandField.values()) {
                        if (field.getID() == id) {
                            return field;
                        }
                        }
