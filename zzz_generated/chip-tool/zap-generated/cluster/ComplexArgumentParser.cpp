...
CHIP_ERROR ComplexArgumentParser::Setup(const char * label,
                                        chip::app::Clusters::Multicast::Structs::MulticastAddStruct::Type & request,
                                        Json::Value & value)
{
    VerifyOrReturnError(value.isObject(), CHIP_ERROR_INVALID_ARGUMENT);
    ...
    ReturnErrorOnFailure(
        ComplexArgumentParser::EnsureMemberExist("MulticastAddStruct.targetId", "targetId", value.isMember("targetId")));
    ReturnErrorOnFailure(
        ComplexArgumentParser::EnsureMemberExist("MulticastAddStruct.endpoints", "endpoints", value.isMember("endpoints")));
    ReturnErrorOnFailure(ComplexArgumentParser::EnsureMemberExist("MulticastAddStruct.key", "key", value.isMember("key")));

    char labelWithMember[kMaxLabelLength];
    snprintf(labelWithMember, sizeof(labelWithMember), "%s.%s", label, "targetId");
    ReturnErrorOnFailure(ComplexArgumentParser::Setup(labelWithMember, request.targetId, value["targetId"]));
    valueCopy.removeMember("targetId");
...
void ComplexArgumentParser::Finalize(chip::app::Clusters::Multicast::Structs::MulticastAddStruct::Type & request)
{
    ComplexArgumentParser::Finalize(request.targetId);
    ComplexArgumentParser::Finalize(request.endpoints);
                                        ...
                                        Json::Value & value)
{
    ...
    ReturnErrorOnFailure(
        ComplexArgumentParser::EnsureMemberExist("MulticastTargetStruct.targetId", "targetId", value.isMember("targetId")));
    ReturnErrorOnFailure(
