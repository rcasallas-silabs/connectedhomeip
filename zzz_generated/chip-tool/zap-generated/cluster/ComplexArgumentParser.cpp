...
CHIP_ERROR ComplexArgumentParser::Setup(const char * label,
                                        chip::app::Clusters::Multicast::Structs::MulticastGroupStruct::Type & request,
                                        Json::Value & value)
{
    VerifyOrReturnError(value.isObject(), CHIP_ERROR_INVALID_ARGUMENT);
    ...
    ReturnErrorOnFailure(
        ComplexArgumentParser::EnsureMemberExist("MulticastGroupStruct.groupId", "groupId", value.isMember("groupId")));
    ReturnErrorOnFailure(
        ComplexArgumentParser::EnsureMemberExist("MulticastGroupStruct.endpoints", "endpoints", value.isMember("endpoints")));
...
void ComplexArgumentParser::Finalize(chip::app::Clusters::Multicast::Structs::MulticastGroupStruct::Type & request)
{
    ComplexArgumentParser::Finalize(request.groupId);
    ComplexArgumentParser::Finalize(request.endpoints);
    ComplexArgumentParser::Finalize(request.fabricIndex);
