...
static CHIP_ERROR Setup(const char * label, chip::app::Clusters::Multicast::Structs::MulticastAddStruct::Type & request,
                        Json::Value & value);

static void Finalize(chip::app::Clusters::Multicast::Structs::MulticastAddStruct::Type & request);
