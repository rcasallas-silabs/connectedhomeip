...
char const * AttributeIdToText(chip::ClusterId cluster, chip::AttributeId id)
{
    ...
    case chip::app::Clusters::Multicast::Id: {
        switch (id)
        {
        case chip::app::Clusters::Multicast::Attributes::Groups::Id:
            return "Groups";
...
char const * AcceptedCommandIdToText(chip::ClusterId cluster, chip::CommandId id)
{
    ...
    case chip::app::Clusters::Multicast::Id: {
        switch (id)
        {
        case chip::app::Clusters::Multicast::Commands::SetGroup::Id:
            return "SetGroup";
        case chip::app::Clusters::Multicast::Commands::RemoveGroup::Id:
            return "RemoveGroup";
        default:
            return "Unknown";
        }
