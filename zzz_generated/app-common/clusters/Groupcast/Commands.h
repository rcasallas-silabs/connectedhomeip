...
public:
    // Use GetCommandId instead of commandId directly to avoid naming conflict with CommandIdentification in ExecutionOfACommand
    static constexpr CommandId GetCommandId() { return Commands::LeaveAllGroups::Id; }
    static constexpr ClusterId GetClusterId() { return Clusters::Groupcast::Id; }
...
public:
    // Use GetCommandId instead of commandId directly to avoid naming conflict with CommandIdentification in ExecutionOfACommand
    static constexpr CommandId GetCommandId() { return Commands::JoinGroupResponse::Id; }
    static constexpr ClusterId GetClusterId() { return Clusters::Groupcast::Id; }

    chip::ByteSpan address;
