...
## New Features for v2.3.0-1.3-beta.1

- Update to use [WiSeConnect 3 SDK (WiFi SDK) v3.1.3-matter-hotfix.1](https://docs.silabs.com/wiseconnect/3.1.3/wiseconnect-developing-with-wiseconnect-sdk/)
- Enhanced 917 SoC stability and sleep functionality
  - Tickless idle support
- Alpha support for Multi-OTA framework
